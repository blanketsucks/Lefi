...
class EmbedImage:
    def __init__(self, *, url: str, height: int=MISSING, width: int=MISSING) -> None:
        self.url = url
        self.height = height
        self.width = width
...
class EmbedAuthor:
    def __init__(self, *, name: str, url: str=MISSING, icon_url: str=MISSING) -> None:
        self.name = name
        self.url = url
        self.icon_url = icon_url
...
class Embed:
    def __init__(
        ...
        *, 
        ...
        self.color = color
        self.url = url
        self.timestamp = timestamp.isoformat() if timestamp is not MISSING else timestamp
        self.footer = footer
        self.image = image
        self.video = video
